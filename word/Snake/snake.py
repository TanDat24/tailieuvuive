...
class SNAKE:
    ...
    def draw_snake(self):
        self.head_update_graphics()
        self.tail_update_graphics()
...
class MAIN:
    ...
    def draw_score(self):
        ...
        x_rect_score = int((cell_size * cell_number) - 60)
        y_rect_score = int((cell_size * cell_number) - 60)
        score_rect = score_surface.get_rect(center = (x_rect_score,y_rect_score))
...
#sound
eat_sound = pygame.mixer.Sound('Sound/crunch.wav')
